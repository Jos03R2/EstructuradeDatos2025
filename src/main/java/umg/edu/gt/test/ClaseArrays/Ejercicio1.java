...
public class Ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(riquezaMaxima(cuentas1)); // Salida: 6
        System.out.println(riquezaMaxima(cuentas2)); // Salida: 10
        System.out.println(riquezaMaxima(cuentas3)); // Salida: 17
    }
}
